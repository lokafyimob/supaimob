      ...
      <div className="hidden lg:block flex-1 relative overflow-hidden" style={{background: 'linear-gradient(to bottom right, #ff6b7a, #ff4352, #e03e4d)'}}>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white p-8 max-w-md">
            ...
            <h1 className="text-5xl font-extrabold mb-2 tracking-wide" style={{fontFamily: '"Gia Variable", "Inter", "Arial Black", sans-serif', fontWeight: '900', textShadow: '2px 2px 4px rgba(0,0,0,0.3)', letterSpacing: '1px'}}>
              AVSISTEM
            </h1>
